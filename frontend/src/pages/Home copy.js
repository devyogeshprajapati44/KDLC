...
const RECORDS = [
  {
    ...
    description: "Book your temple darshan ticket.",
    price: 100,
    category: "Darshan",
    image: "/images/teample/ganeshji.jpg",
  },
  {
    id: 2,
    title: "Special Darshan",
    description: "Priority temple darshan.",
    price: 250,
    category: "Darshan",
    image: "/images/teample/ganeshji.jpg",
  },
  ...
  },
  {
    ...
    description: "Book temple prasad.",
    price: 251,
    category: "Prasad",
    image: "/images/teample/ganeshji.jpg",
  },
  ...
  },
  {
    id: 7,
    title: "Rudrabhishek",
    description: "Book Rudrabhishek Puja.",
    price: 2100,
    category: "Puja",
    image: "/images/teample/ganeshji.jpg",
  },
  {
    ...
    description: "Book Satyanarayan Katha.",
    price: 1500,
    category: "Puja",
    image: "/images/teample/ganeshji.jpg",
  },
  {
    ...
    description: "Hanuman Chalisa Path.",
    price: 301,
    category: "Path",
    image: "/images/teample/ganeshji.jpg",
  },
  {
    id: 10,
    title: "Annadan Seva",
    description: "Contribute to Annadan.",
    price: 1001,
    category: "Seva",
    image: "/images/teample/ganeshji.jpg",
  },
  ...
  return (
    <article className="product-card">
      <div className="product-card__image">
        <div className="product-card__pattern"></div>
      ...
      <nav className="temple-nav">
        <div className="temple-container temple-nav__inner">
          <div className="temple-logo">
            ...
            <div className="temple-logo__symbol">
              ॐ
            </div>
        ...
        <div className="temple-hero__pattern"></div>
          <div className="temple-container temple-hero__content">
            <div className="temple-hero__text">
               <div className="temple-hero__eyebrow">
                ...
                <h1> Book your 
                    <span> divine journey.</span>
                </h1>
                <p>
                Experience peaceful darshan, sacred puja,
                aarti seva and temple services. Book your
                visit easily and securely with KDLC Temple
                Booking.
                </p>
          ...
          >
            ...
            <div className="temple-arch">
              ...
              <div className="arch__outer">

                <div className="arch__inner"></div>

              </div>

              <div className="temple-building">

                <div className="temple-roof temple-roof--one">
                  <span></span>
                </div>

                <div className="temple-roof temple-roof--two">
                  <span></span>
                </div>
            ...
            <div className="hero__bell">
              ...
              <div className="bell__body">
                ...
                <div className="bell__clapper"></div>
      ...
      <section className="quick-booking">
        ...
        <div className="temple-container">
          ...
          <div className="quick-booking__box">
            ...
            <div className="quick-booking__icon">
              📅
            </div>
            ...
            <button
              type="button"
              className="quick-booking__button"
              onClick={scrollToProducts}
            >
        ...
        <div className="temple-container temple-about__grid">
          ...
          <div className="about__content">
            ...
            <p>
              ...
              KDLC Temple Booking provides a simple and
              reliable way to plan your temple visit.
              Book darshan, puja, aarti, prasad and other
        ...
        <div className="temple-container">
          ...
          <div className="features-grid">
            ...
            <div className="feature">
              ...
              <p>
                Book your temple services quickly
                from anywhere.
              </p>
            ...
            <div className="feature">
              ...
              <p>
                Access your booking details and
            ...
            <div className="feature">
              ...
              <p>
                Plan your visit in advance and enjoy
          ...
          <div className="timings-card">
            ...
            <div className="timings-card__left">
              ...
              <p>
                ...
                Plan your visit according to the daily
                temple schedule and make your spiritual
                journey peaceful and memorable.
            ...
            <div className="timings-card__right">
              ...
              <div className="timing-row timing-row--highlight">
        ...
        <div className="temple-container temple-cta__content">
          ...
          <div>
            ...
            <p>
              ...
              Choose your temple service and book your
              experience today.
          ...
          <div className="footer__top">
            ...
            <div className="footer__brand">
              ...
              <p>
                ...
                A simple and secure platform for booking
                temple darshan, puja, seva and other
